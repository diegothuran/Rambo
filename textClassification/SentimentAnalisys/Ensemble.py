...
class Ensemble():
    ...
    def load_classifiers(self):
        ...
        svm_product = joblib.load('textClassification/SentimentAnalisys/ClassifierWeigths/svm.pkl')
        svm_store = joblib.load('textClassification/SentimentAnalisys/ClassifierWeigths/svm2.pkl')
